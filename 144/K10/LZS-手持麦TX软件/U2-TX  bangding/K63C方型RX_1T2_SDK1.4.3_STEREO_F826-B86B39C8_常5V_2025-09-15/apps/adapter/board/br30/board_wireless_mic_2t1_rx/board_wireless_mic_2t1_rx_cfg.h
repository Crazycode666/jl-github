...
//                                 UART配置                                        //
//*********************************************************************************//
#define TCFG_UART0_ENABLE					DISABLE_THIS_MOUDLE//ENABLE_THIS_MOUDLE                     //串口打印模块使能
...
#define TCFG_CHARGE_MA						CHARGE_mA_160
//涓流电流
...
#define TCFG_PWMLED_PIN0					IO_PORTB_07					//LED使用的IO口 注意和led7是否有io冲突

#define TCFG_PWMLED_PIN1					IO_PORTB_08				//红灯
#define TCFG_PWMLED_PIN2					IO_PORTA_03	            //绿灯
#define TCFG_PWMLED_PIN3					IO_PORTA_01         	//蓝灯
...
//                                  系统配置                                         //
//*********************************************************************************//
#define TCFG_AUTO_SHUT_DOWN_TIME		    170   //没有蓝牙连接自动关机时间
...
#define WL_LOW_DELAY_LIMIT              18
#elif (WIRELESS_CODING_FRAME_LEN == 75)
#define WL_LOW_DELAY_LIMIT              22//19
#elif (WIRELESS_CODING_FRAME_LEN == 100)
#define WL_LOW_DELAY_LIMIT              22//22
#endif
#endif
//<!信号不好，高延时门限
#define WL_HIGH_DELAY_LIMIT             WL_LOW_DELAY_LIMIT
