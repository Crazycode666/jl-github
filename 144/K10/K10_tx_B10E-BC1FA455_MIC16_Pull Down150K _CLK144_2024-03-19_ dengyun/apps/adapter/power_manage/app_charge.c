...
static u16 charge_full_led_time = 0;
void charge_full_led_deal_add()
{
    if(!charge_full_led_time)
    {
        charge_full_led_time = sys_timer_add(NULL,charge_full_led_deal,CHARGE_FULL_TIME * 1000);
    }
}

void charge_full_led_deal_del()
{
    if(charge_full_led_time)
    {
        sys_timeout_del(charge_full_led_time);
        charge_full_led_time = 0;
    }
}
