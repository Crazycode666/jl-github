...
#define POWER_OFF_CNT       4
#define PAIR_BANDING_CLEAR_CNT     1
...
static int adapter_key_event_handler(struct sys_event *event)
{
    ...
    static u8 key_clear_pair_cnt = 0;
    ...
    case KEY_WIRELESS_MIC_DENOISE_SET:
        ...
        if(!exit_mic_flag && mic_open_flag == 0)
        {
            ...
            if (wireless_mic_media) {
                ...
                case 1:
                    ...
                    user_pwm_led_on(TCFG_PWMLED_PIN0);
                    set_timer_pwm_duty(JL_TIMER4,8000);
                    break;
                case 2:
                    //深度降噪
    ...
    case  KEY_EXIT_MIC:
        ...
        if(connect_state_flag)
        {
            ...
            if(exit_mic_flag)
            {
                ...
                exit_mic_flag = 0;
                gpio_disable_fun_output_port(TCFG_PWMLED_PIN2);
                rgb_led_off(TCFG_PWMLED_PIN1);//关闭降噪灯
                rgb_led_off(TCFG_PWMLED_PIN2);//关闭原声灯
    ...
    case  KEY_POWEROFF_HOLD:
        ...
        if (flag_poweroff) {
            ...
            /*if (++key_clear_pair_cnt >= PAIR_BANDING_CLEAR_CNT) {
                #if WIRELESS_PAIR_BONDING
                    clear_bonding_info();
                    ble_module_enable(1);
                #endif // WIRELESS_PAIR_BONDING
