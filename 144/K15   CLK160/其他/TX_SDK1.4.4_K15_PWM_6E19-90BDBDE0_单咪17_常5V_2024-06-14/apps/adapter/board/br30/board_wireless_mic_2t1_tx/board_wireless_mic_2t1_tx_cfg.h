...
#define WIRELESS_HOWLING_ENABLE			ENABLE	//防啸叫
...
#define WIRELESS_MIC_ADC_RESUME_CODING_EN   DISABLE
#endif
#define WIRELESS_MIC_ADC_GAIN				(17)//mic增益设置,使用单端麦adc增益建议设置为10，用户可根据自己需求修改
...
#define TCFG_PWMLED_PIN						IO_PORTB_06					//电量，红灯

#define TCFG_PWMLED_PIN0						IO_PORTC_02	            //23脚红灯，静音
#define TCFG_PWMLED_PIN1						IO_PORTC_03             //22脚绿灯，开机默认降噪
#define TCFG_PWMLED_PIN2						IO_PORTC_04	            //21脚蓝灯，默认原声

#define TCFG_PWMLED_PIN3						IO_PORTB_08             //4脚， 电量,绿灯
#define TCFG_PWMLED_PIN4						IO_PORTB_02				//13脚，电量 蓝灯
