...
#define WIRELESS_2t1_RX_ONLY_CONN_1TX		ENABLE
...
//                                 iokey 配置                                      //
//*********************************************************************************//
#define TCFG_IOKEY_ENABLE					ENABLE_THIS_MOUDLE//DISABLE_THIS_MOUDLE//ENABLE_THIS_MOUDLE //是否使能IO按键
...
#define TCFG_PWMLED_PIN0                    IO_PORTB_07                 //5脚
