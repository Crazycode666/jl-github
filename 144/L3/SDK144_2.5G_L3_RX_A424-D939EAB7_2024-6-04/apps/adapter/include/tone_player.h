...
#define TONE_MIC_CONN       	TONE_RES_ROOT_PATH"tone/mic_conn.*"
#define TONE_MIC_DISCONN    	TONE_RES_ROOT_PATH"tone/mic_dconn.*"

#define TONE_BT_OFF       		TONE_RES_ROOT_PATH"tone/bt_off.*"
#define TONE_BT_ON       		TONE_RES_ROOT_PATH"tone/bt_on.*"

#define TONE_ECHO_OFF       	TONE_RES_ROOT_PATH"tone/echo_off.*"
#define TONE_ECHO_ON       		TONE_RES_ROOT_PATH"tone/echo_on.*"

#define TONE_DENOISE_OFF       	TONE_RES_ROOT_PATH"tone/noise_off.*"
#define TONE_DENOISE_ON       	TONE_RES_ROOT_PATH"tone/noise_on.*"

#define TONE_RECODER_OFF       	TONE_RES_ROOT_PATH"tone/rec_off.*"
#define TONE_RECODER_ON       	TONE_RES_ROOT_PATH"tone/rec_on.*"

#define TONE_VOL_UP       		TONE_RES_ROOT_PATH"tone/vol_up.*"
#define TONE_VOL_DOWN       	TONE_RES_ROOT_PATH"tone/vol_down.*"

#define TONE_MAX_VOL			TONE_RES_ROOT_PATH"tone/vol_max.*"
#define TONE_MINE_VOL			TONE_RES_ROOT_PATH"tone/vol_mine.*"
