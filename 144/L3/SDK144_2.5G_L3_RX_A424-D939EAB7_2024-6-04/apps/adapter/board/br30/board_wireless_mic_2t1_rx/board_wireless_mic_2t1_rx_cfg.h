...
#define TCFG_PWMLED_PIN						IO_PORTB_06					//6脚OTG检测

#define TCFG_PWMLED_PIN0                    IO_PORTB_07                 //5脚充电
#define TCFG_PWMLED_PIN1                    IO_PORTB_08                 //4脚连接
#define TCFG_PWMLED_PIN2                    IO_PORTA_01                 //27脚静音
