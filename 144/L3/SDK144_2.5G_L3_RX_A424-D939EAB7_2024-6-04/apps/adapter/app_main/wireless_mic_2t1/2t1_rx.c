...
u8 user_dig_vol_step = USER_DIGITAL_VOL_MAX;
...
static int adapter_key_event_handler(struct sys_event *event)
{
    ...
    case KEY_EXIT_MIC:
        ...
        if(mic_flag)
        {
            ...
            //wl_mic_tone_play(TONE_RECODER_OFF, 0, NULL, NULL);

        }
        else{
            user_dig_vol_step = 10;
            echo_led_off(TCFG_PWMLED_PIN2);
            //wl_mic_tone_play(TONE_RECODER_ON, 0, NULL, NULL);
    ...
    case SYS_DEVICE_EVENT:
        ...
        case DEVICE_EVENT_FROM_ADAPTER:
            ...
            case ADAPTER_EVENT_CONNECT :
                ...
                //wl_mic_tone_play(TONE_MIC_CONN, 0, NULL, NULL);
                led_flash_del();
            ...
            case ADAPTER_EVENT_DISCONN :
                ...
                //wl_mic_tone_play(TONE_MIC_DISCONN, 0, NULL, NULL);
                if(dev_num == 1)
                {
                    //led_flash_add();
