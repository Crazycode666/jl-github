...
const struct eq_seg_info eq_tab_normal[] = {
    ...
    //10段之后频率值设置65k,目的是让10段之后的eq走直通
    {10, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {11, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {12, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {13, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {14, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {15, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {16, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {17, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {18, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
    {19, EQ_IIR_TYPE_BAND_PASS, 65000, 0 << 20, (int)(0.7f * (1 << 24))},
#endif
...
#endif
    {0, EQ_IIR_TYPE_HIGH_PASS, 200,   0 * (1 << 20), 0.7f * (1 << 24)},
    {1, EQ_IIR_TYPE_BAND_PASS, 300,   0 * (1 << 20), 0.7f * (1 << 24)},
    {2, EQ_IIR_TYPE_BAND_PASS, 400,   0 * (1 << 20), 0.7f * (1 << 24)},
};
#endif
...
static void eq_online_callback_spp(uint8_t *packet, uint16_t size)
{
    ...
    //检查是否为在线升级指令
    if (!check_online_update(event, packet, size)) {
...
#if APP_ONLINE_DEBUG
        if (eq_cfg->app) {
            ci_send_callback(eq_cfg->send_cmd);
