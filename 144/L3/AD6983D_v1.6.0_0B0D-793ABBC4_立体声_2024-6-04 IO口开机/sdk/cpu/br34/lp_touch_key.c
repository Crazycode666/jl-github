...
//==============================================================//
    if (__this->config->ch1.enable) {
        ...
        //模拟参数配置:
        LP_CTMU_CH1_CUR_SEL(CUR_SEL_1040UA);
        LP_CTMU_CH1_VH_SEL(VHSEL_075V);
        LP_CTMU_CH1_VL_SEL(VLSEL_030V);
        ...
        LP_CTMU_CH1_STABLE_TH(ch1_sensitivity_table[ch1_sensity].cfg1);
...
//==============================================================//
    ...
    if (__this->config->ch0.enable) {
        ...
        LP_CTMU_CH0_STABLE_TH(lp_key_online.ch0_debug_cfg.cfg1);
...
//==============================================================//
    if (__this->config->ch1.enable) {
        ...
        LP_CTMU_CH1_STABLE_TH(lp_key_online.ch1_debug_cfg.cfg1);
