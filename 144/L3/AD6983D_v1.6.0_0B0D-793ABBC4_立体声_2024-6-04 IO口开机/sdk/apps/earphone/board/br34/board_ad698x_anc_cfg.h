#ifndef CONFIG_BOARD_AD698X_ANC_CFG_H
#define CONFIG_BOARD_AD698X_ANC_CFG_H

#include "board_ad698x_anc_global_build_cfg.h"

#ifdef CONFIG_BOARD_AD698X_ANC
...
#else
#define TCFG_AUDIO_ANC_ENABLE				ANC_CLOSE_MODE
#define TCFG_ANC_TOOL_DEBUG_ONLINE 			DISABLE_THIS_MOUDLE//ANC工具蓝牙spp调试
#endif
#if (!TCFG_AUDIO_ANC_ENABLE) && (TCFG_ANC_TOOL_DEBUG_ONLINE)
#error	"ANC must be opened before opening the ANC_TOOL_DEBUG_ONLINE !"
#endif
/*
...
#define TCFG_AUDIO_MIC_PWR_PORT				IO_PORTB_08
...
//                                  EQ配置                                         //
//*********************************************************************************//
//EQ配置，使用在线EQ时，EQ文件和EQ模式无效。有EQ文件时，需使能TCFG_USE_EQ_FILE,才会去解析EQ文件
...
#define CONFIG_BT_CALL_KWS_HZ           (96 * 1000000L)
...
#endif //CONFIG_BOARD_AD698X_ANC
#endif //CONFIG_BOARD_AD698X_ANC_CFG_H
