...
#include "board_ad6983d_global_build_cfg.h"
...
//                             lp tocuh key 配置                                   //
//*********************************************************************************//
#define TCFG_LP_TOUCH_KEY_ENABLE 			0//CONFIG_LP_TOUCH_KEY_EN  //是否使能触摸按键
...
*/
#define TCFG_AUDIO_DAC_CONNECT_MODE        DAC_OUTPUT_LR //DAC_OUTPUT_MONO_LR_DIFF
...
#if (DUEROS_DMA_EN || TRANS_DATA_EN || TUYA_DEMO_EN)
