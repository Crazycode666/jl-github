...
u8 key_table[KEY_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    {KEY_MUSIC_PP,   KEY_ANC_SWITCH,  KEY_POWEROFF_HOLD,  KEY_NULL,     KEY_CALL_LAST_NO,     KEY_MUSIC_NEXT},   //KEY_0
...
#endif /* #ifdef CONFIG_BOARD_AD698X_ANC */
