...
#define WIRELESS_2T1_MICROPHONE_MODE	ENABLE

#define WIRELESS_24G_ENABLE				ENABLE //使能此功能可以屏蔽手机搜索到此无线设备名
#define WIRELESS_NOISEGATE_EN		    DISABLE//噪声门限使能
#define WIRELESS_ECHO_ENABLE			ENABLE //混响
#define WIRELESS_HOWLING_ENABLE			DISABLE//ENABLE	//防啸叫
...
//                                 UART配置                                        //
//*********************************************************************************//
#define TCFG_UART0_ENABLE					DISABLE //ENABLE_THIS_MOUDLE //串口打印模块使能
#define TCFG_UART0_RX_PORT					NO_CONFIG_PORT                         //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
#define TCFG_UART0_TX_PORT  				NO_CONFIG_PORT//IO_PORT_DP                               //串口发送脚配置
...
#define USB_DEVICE_CLASS_CONFIG             MASSSTORAGE_CLASS//0
...
#define SYS_VOL_TYPE            VOL_TYPE_DIGITAL//VOL_TYPE_ANALOG
 ...
 * */
#define TCFG_AUDIO_MIC_MODE					MIC_MODE_DIFF_END//AUDIO_MIC_CAP_DIFF_MODE
...
#define WIRELESS_MIC_ADC_RESUME_CODING_EN   DISABLE
#endif
#define WIRELESS_MIC_ADC_GAIN				(18)//mic增益设置,使用单端麦adc增益建议设置为10，用户可根据自己需求修改
...
#define TCFG_PWMLED_PIN						IO_PORTB_06					//6脚，混响灯

#define TCFG_PWMLED_PIN0						IO_PORTB_03			    //12脚，连接灯
#define TCFG_PWMLED_PIN1						IO_PORTB_02             //13脚，降噪灯
#define TCFG_PWMLED_PIN2						IO_PORTC_02	            //23脚，混响灯
#define TCFG_PWMLED_PIN3						IO_PORTC_03             //22脚，静音灯


//*********************************************************************************//
//                                  EQ配置                                         //
//*********************************************************************************//
#define TCFG_EQ_ENABLE						0//ENABLE_THIS_MOUDLE
...
//                                  系统配置                                         //
//*********************************************************************************//
#define TCFG_AUTO_SHUT_DOWN_TIME		    360   //没有蓝牙连接自动关机时间
...
#define WIRELESS_CLK							160//144//tx需要跑快一点，否则算法可能跑不过来
#endif
//*********************************************************************************//
//                                  encoder 配置                                   //
//*********************************************************************************//
...
#define USER_DEFINE_TONE    1
#define WIRELESS_TX_ALWAYS_RUN_STREAM 1
