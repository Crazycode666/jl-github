...
{
    timer_pwm_init(JL_TIMER4,TCFG_PWMLED_PIN2,200,10000);
...
void user_pwm_led_on(u32 gpio_port)
{
    timer_pwm_init(JL_TIMER3,gpio_port,200,2500);
    //timer_pwm_init(JL_TIMER2,TCFG_PWMLED_PIN2,200,0);
}

void user_pwm_vbat_led_on(u32 gpio_port)
{
    timer_pwm_init(JL_TIMER2,gpio_port,200,4000);
    timer_pwm_init(JL_TIMER2,TCFG_PWMLED_PIN1,200,0);
}
...
void led_flash_add()
{
    if(!led_time)
    {
        led_time = sys_timer_add(NULL,led_flash,900);
    }
}
...
void red_led_flash_add()
{
    if(!red_led_time)
    {
        red_led_time = sys_timer_add(NULL,red_led_flash,900);
    }
}
