...
#define TCFG_PWMLED_PIN						IO_PORTB_06                  //静音降噪

#define TCFG_PWMLED_PIN0						IO_PORT_DM              //静音灯
#define TCFG_PWMLED_PIN1						IO_PORT_DP              //降噪灯

#define TCFG_PWMLED_PIN2						IO_PORTB_02				//9脚，混响灯
