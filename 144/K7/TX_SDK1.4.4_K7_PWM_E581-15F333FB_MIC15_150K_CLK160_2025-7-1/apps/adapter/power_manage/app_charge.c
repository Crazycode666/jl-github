...
static u16 charge_full_time = 0;
void charge_full_led_display(void)
{
...
void charge_full_led_display_add()
{
    if(!charge_full_time)
    {
        charge_full_time = sys_timer_add(NULL,charge_full_led_display,10 * 1000);
    }
}
