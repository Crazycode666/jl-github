...
{
    #if 1
    gpio_led_high_block(IO_PORTB_07);
...
{
    #if 1
    echo_led_off(IO_PORTB_07);				//拉低Pin1
    ...
    #else
    pwm_led_off(IO_PORTB_07);				//拉低Pin1
    if(nums[unit] & BIT(5))	//B3
