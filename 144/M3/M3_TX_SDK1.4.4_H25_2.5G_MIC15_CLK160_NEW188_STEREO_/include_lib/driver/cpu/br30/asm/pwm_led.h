...
#define PWM_LED_TWO_IO_SUPPORT				 0	//定义该宏会支持两个IO推灯模式, 默认关闭
#define PWM_LED_TWO_IO_CONNECT			     1  //两个IO LED 接法: 0->一端接地 , 1->一端接高

#define PWM_LED_THREE_IO_SUPPORT					//定义该宏会支持3个IO推灯模式, 默认关闭

#define CFG_LED0_LIGHT						150  	//10 ~ 500, 值越大, (红灯)亮度越高
#define CFG_LED1_LIGHT						150  	//10 ~ 500, 值越大, (蓝灯)亮度越高

#define CFG_SINGLE_FAST_FLASH_FREQ			600		//LED单独快闪速度, ms闪烁一次(100 ~ 1000)
#define CFG_SINGLE_FAST_LIGHT_TIME 			200  	//单灯快闪灯亮持续时间, 单位ms
...
/***************** 呼吸模式配置参数, 可供调节参数 ********************/
#define CFG_LED_BREATH_TIME 				3000		//呼吸时间灭->亮->灭, 单位ms
#define CFG_LED0_BREATH_BRIGHT 				300			//呼吸亮度, 范围: 0 ~ 500
#define CFG_LED1_BREATH_BRIGHT 				150			//呼吸亮度, 范围: 0 ~ 500
#define CFG_LED_BREATH_BLINK_TIME 			700		//灭灯延时, 单位ms
