...
#define CFG_SINGLE_FAST_FLASH_FREQ			950		//LED单独快闪速度, ms闪烁一次(100 ~ 1000)
#define CFG_SINGLE_FAST_LIGHT_TIME 			170  	//单灯快闪灯亮持续时间, 单位ms

#define CFG_SINGLE_SLOW_FLASH_FREQ			10000	//LED单独慢闪速度, ms闪烁一次(1000 ~ 20000)
