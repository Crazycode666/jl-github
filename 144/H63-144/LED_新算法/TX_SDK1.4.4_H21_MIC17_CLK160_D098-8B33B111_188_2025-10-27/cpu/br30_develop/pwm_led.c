...
{
    #if 1
    gpio_led_high_block(IO_PORTC_05);
    gpio_led_high_block(IO_PORTC_04);
    gpio_led_high_block(IO_PORTC_03);
    gpio_led_high_block(IO_PORTC_02);
    gpio_led_high_block(IO_PORTB_03);
    #else
    echo_led_off(IO_PORTC_05);
    echo_led_off(IO_PORTC_04);
    echo_led_off(IO_PORTC_03);
...
void Display_Scan2(void)
{
	...
	if(nums[tens] & BIT(2))	//E2
		echo_led_on(IO_PORTC_02);
    #else
    pwm_led_off(IO_PORTC_04);
    if(nums[unit] & BIT(6))	//A3
    	pwm_led_on(IO_PORTC_05);
	if(nums[tens] & BIT(5))	//B2
		pwm_led_on(IO_PORTB_03);
	if(nums[tens] & BIT(3))	//D2
		pwm_led_on(IO_PORTC_03);
