...
#define WIRELESS_2T1_MICROPHONE_MODE	0//ENABLE
...
//                                 UART配置                                        //
//*********************************************************************************//
#define TCFG_UART0_ENABLE					DISABLE        //串口打印模块使能
...
#define TCFG_CHARGE_MA						CHARGE_mA_70
//涓流电流
...
#define WIRELESS_MIC_ADC_RESUME_CODING_EN   DISABLE
#endif
#define WIRELESS_MIC_ADC_GAIN				(13)//mic增益设置,使用单端麦adc增益建议设置为10，用户可根据自己需求修改
...
#define TCFG_PWMLED_PIN						IO_PORTC_02     	        //静音降噪

#define TCFG_PWMLED_PIN0						IO_PORTB_02	            //9脚绿灯，电量
#define TCFG_PWMLED_PIN1						IO_PORTC_00             //DP脚红灯，电量

#define TCFG_PWMLED_PIN2						IO_PORTB_06				//3脚，连接绿灯
//#define TCFG_PWMLED_PIN4						IO_PORTB_03				//12脚，电量,黄灯
...
#define TCFG_PHONE_EQ_ENABLE				ENSABLE_THIS_MOUDLE
...
#define WIRELESS_CLK							144 //144 tx需要跑快一点，否则算法可能跑不过来
#endif
//*********************************************************************************//
//                                  encoder 配置                                   //
//*********************************************************************************//
