...
#define WIRELESS_LLNS_ENABLE			1//DISABLE //支持16k,32k,48K采样率,低延时降噪,延时低，降噪算法时间5ms
...
#define WIRELESS_MIC_ADC_RESUME_CODING_EN   DISABLE
#endif
#define WIRELESS_MIC_ADC_GAIN				(16)//mic增益设置,使用单端麦adc增益建议设置为10，用户可根据自己需求修改
...
#define TCFG_PWMLED_PIN						IO_PORTB_06              	//6脚 连接灯
#define TCFG_PWMLED_PIN0						IO_PORTB_08            //5脚，静音
#define TCFG_PWMLED_PIN1						IO_PORTC_05            //20脚，降噪
