...
#define WIRELESS_MIC_ADC_RESUME_CODING_EN   DISABLE
#endif
#define WIRELESS_MIC_ADC_GAIN				(14)//mic增益设置,使用单端麦adc增益建议设置为10，用户可根据自己需求修改
...
#define TCFG_PWMLED_PIN						IO_PORTB_08             	//4脚 连接灯
#define TCFG_PWMLED_PIN0						IO_PORTB_07              //5脚，静音
#define TCFG_PWMLED_PIN1						IO_PORTB_06            //6脚，降噪
