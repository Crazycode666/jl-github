...
#define CFG_LED1_LIGHT						300  	//10 ~ 500, 值越大, (蓝灯)亮度越高

#define CFG_SINGLE_FAST_FLASH_FREQ			400		//LED单独快闪速度, ms闪烁一次(100 ~ 1000)
#define CFG_SINGLE_FAST_LIGHT_TIME 			200  	//单灯快闪灯亮持续时间, 单位ms

#define CFG_SINGLE_SLOW_FLASH_FREQ			800	//LED单独慢闪速度, ms闪烁一次(1000 ~ 20000)
#define CFG_SINGLE_SLOW_LIGHT_TIME 			200  	//单灯慢闪灯亮持续时间, 单位ms
...
#define CFG_LED_BREATH_BLINK_TIME 			500		//灭灯延时, 单位ms
