...
const u16 key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    //单击             //长按          //hold         //抬起            //双击                //三击
    [0] = {
        KEY_EXIT_MIC, KEY_POWEROFF,		KEY_POWEROFF_HOLD,	KEY_NULL,	    KEY_NULL,			KEY_NULL
    },
    [1] = {
        KEY_WIRELESS_MIC_ECHO_SET,		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [2] = {
        KEY_WIRELESS_MIC_DENOISE_SET,	KEY_NULL,	KEY_NULL,			KEY_NULL,		KEY_NULL,	KEY_NULL
    },
    [3] = {
