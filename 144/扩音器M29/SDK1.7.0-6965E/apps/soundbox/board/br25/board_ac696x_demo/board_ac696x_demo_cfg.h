...
#define TCFG_HOST_AUDIO_ENABLE				1//DISABLE_THIS_MOUDLE
...
#define TCFG_IOKEY_PAUSE_CONNECT_WAY 		ONE_PORT_TO_LOW  //按键一端接低电平一端接IO
#define TCFG_IOKEY_PAUSE_ONE_PORT			IO_PORTA_03
...
#define TCFG_PWMLED_IOMODE					LED_ONE_IO_MODE				//LED模式，单IO还是两个IO推灯
#define TCFG_PWMLED_PIN						IO_PORTB_07					//LED使用的IO口 注意和led7是否有io冲突
...
#define TCFG_DEC_FLAC_ENABLE				1//DISABLE
