...
#define TCFG_PWMLED_PIN						IO_PORTA_01 //IO_PORTB_06					//LED使用的IO口 注意和led7是否有io冲突

#define TCFG_PWMLED_PIN0                    IO_PORTB_06//IO_PORTA_01                 //16脚
...
#else
#if WIRELESS_LOW_LATENCY
#define WL_LOW_DELAY_LIMIT              5
#else
#define WL_LOW_DELAY_LIMIT              8
#endif
