...
void led_flash_add()
{
    if(!led_time)
    {
        led_time = sys_timer_add(NULL,led_flash,1000);
    }
}
...
void exit_led_flash_add()
{
    if(!exit_led_time)
    {
        exit_led_time = sys_timer_add(NULL,exit_led_flash,1000);
    }
}

void exit_led_flash_del()
{
    if(exit_led_time)
    {
        sys_timer_del(exit_led_time);
        exit_led_time = 0;
    }
}
...
void led_water_flash_add()
{
    ...
    led_water_time = sys_timer_add(NULL,led_water_flash,1500);
