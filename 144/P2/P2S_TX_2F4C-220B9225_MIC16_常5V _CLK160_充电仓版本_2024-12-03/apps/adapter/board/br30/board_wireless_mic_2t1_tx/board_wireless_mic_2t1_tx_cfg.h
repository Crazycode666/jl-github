...
#define WIRELESS_ECHO_ENABLE			DISABLE//DISABLE //混响
...
#define TCFG_PWMLED_PIN0						IO_PORTB_08             //4脚
#define TCFG_PWMLED_PIN1						IO_PORTB_02         	//13脚
#define TCFG_PWMLED_PIN2						IO_PORTC_02             //23脚
#define TCFG_PWMLED_PIN3						IO_PORTC_03             //22脚
#define TCFG_PWMLED_PIN4						IO_PORTC_04             //21脚
...
//                                  系统配置                                         //
//*********************************************************************************//
#define TCFG_AUTO_SHUT_DOWN_TIME		    300   //没有蓝牙连接自动关机时间
